  ...
  const imageStyle = {
   ...
   return (
      ...
      <div className="mx-auto max-w-2xl lg:max-w-7xl">
        <div className="mt-6 max-h-fit grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-6">
          {props.promotions.map((promotion) => (
            <div key={promotion.id} className="group relative border p-1">
              ...
              <Image
                ...
                className="h-36 w-full object-cover object-center lg:w-full"
