    ...
    <>
      ...
      >
        <div className="mx-5 flex h-m h-16 max-w-screen-xl items-center justify-between xl:mx-auto">
          <Link href="/" className="flex h-10 items-center font-display text-xs sm:text-md md:text-2xl">
            <Image
              src="/logo.png"
              alt="Precedent logo"
              width="30"
          ...
          <div>
            {session ? (
              ...
              <button
                className="rounded-full h-10 border border-teal-800 bg-teal-600 px-2 text-sm text-white transition-all hover:bg-white hover:text-teal-700"
