    ...
    <>
      ...
      >
        <div className="mx-5 flex h-m h-16 max-w-screen-xl items-center justify-between xl:mx-auto">
          ...
          {
            location != '/business' && 
            <Link href="/business" className="inline-flex items-center max-w-fit justify-center sm:mr-4 text-xs sm:text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100">
